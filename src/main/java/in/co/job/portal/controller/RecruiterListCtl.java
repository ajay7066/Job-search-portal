...
/**
 * Servlet implementation class RecruiterListCtl
 */
@WebServlet(name = "RecruiterListCtl", urlPatterns = { "/ctl/RecruiterListCtl" })
public class RecruiterListCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				ServletUtility.redirect(JPView.RECRUITER_LIST_CTL, request, response);
				return;
	...
	protected String getView() {
		return JPView.RECRUITER_LIST_VIEW;
	}
